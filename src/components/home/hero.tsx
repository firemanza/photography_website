...
export default function Hero() {
  ...
  return (
    <section className="relative min-h-screen overflow-hidden px-4 pb-12 pt-28 sm:pt-32">
      ...
      <div className="relative z-10 mx-auto grid w-[calc(100%-2rem)] max-w-none gap-10 lg:grid-cols-[1.15fr_0.85fr] lg:items-end">
